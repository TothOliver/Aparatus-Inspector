...
with open(r"c:\Users\johan\OneDrive\Desktop\awtbg\Scripts\monster_character.gd", "w", encoding="utf-8") as f:
    f.write(gdscript_content)

print("Updated Scripts/monster_character.gd with all 5 requested poses!")
